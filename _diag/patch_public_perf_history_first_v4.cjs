...
const marker = "XS_FIX_FRONT_PERF_HISTORY_FIRST_NO_403_V4";

let text = fs.readFileSync(file, "utf8");

if (text.includes(marker)) {
  console.log("Patch V4 déjà présent, aucune modification.");
  process.exit(0);
}
...
/* XS_FIX_FRONT_PERF_HISTORY_FIRST_NO_403_V4
...
export async function publicPlayerPerformance(
  ...
  const empty: any = {
    ...
    meta: {
      ...
      marker: "XS_FIX_FRONT_PERF_HISTORY_FIRST_NO_403_V4",
